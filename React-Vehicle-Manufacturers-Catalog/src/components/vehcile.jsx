...
const Homepage = () =>{
    ...
    useEffect(()=>{
        fetch('https://vpic.nhtsa.dot.gov/api/vehicles/getallmanufacturers?format=json&page=3')
        .then(response => response.json())
        .then(data =>{
            const manufacturers = data.Results.map(manufacturer=>{
                const type = typeof manufacturer.VehicleTypes === 'string' ? manufacturer.VehicleTypes.split(',')[0] : "Truck"
                return{
        ...
        <div className="container flex-col">
            ...
            <section className='flex-row search'>
                ...
                <div className='flex-row select'>
                    <label htmlFor="filter"><b>Filter by Vehcile Types</b></label>
